...
public class TextFieldAnimation extends JTextField {
    ...
    public TextFieldAnimation() {
        ...
        iconSearch = new ImageIcon(getClass().getResource("/searchbar/search.png"));
        iconClose = new ImageIcon(getClass().getResource("/searchbar/close.png"));
        iconLoading = new ImageIcon(getClass().getResource("/searchbar/loading.gif"));
