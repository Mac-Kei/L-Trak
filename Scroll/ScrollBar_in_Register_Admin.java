 ...
 * @author Raven
 */
public class ScrollBar_in_Register_Admin extends BasicScrollBarUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        return new ScrollBar_in_Register_Admin();
    }

    public ScrollBar_in_Register_Admin() {
    ...
    public void installUI(JComponent c) {
        ...
        c.setForeground(new Color(25,28,36));
        initAnimator();
    }
    ...
    private class ScrollButton extends JButton {
        ...
        protected void paintComponent(Graphics g) {
            ...
            if (mousePress) {
                g2.setColor(new Color(72,45,68));
            } else if (mouseHover) {
                g2.setColor(new Color(72,45,68));
            } else {
                g2.setColor(scrollbar.getForeground());
