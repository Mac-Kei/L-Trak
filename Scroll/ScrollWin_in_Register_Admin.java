 ...
 * @author Raven
 */
public class ScrollWin_in_Register_Admin extends JScrollPane {

    public ScrollWin_in_Register_Admin() {
        getVerticalScrollBar().setUI(new ScrollBar_in_Register_Admin());
        getHorizontalScrollBar().setUI(new ScrollBar_in_Register_Admin());
